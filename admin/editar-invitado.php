...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editar Invitado
        <small>puedes editar los datos del invitado aquí</small>
      </h1>
    </section>
    <div class="row">
      <div class="col-md-8">
                ...
                <form role="form" name="guardar-registro" id="guardar-registro-archivo" method="post" action="modelo-invitado.php" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="8" id="biografia_invitado" name="biografia_invitado" placeholder="Biografia"><?php echo $invitado['descripcion'] ?></textarea>
                      </div>

                      <div class="form-group">
                        <label for="imagen_actual">Imagen Actual</label>
                        <br>
                        <img src="../img/invitados/<?php echo $invitado['url'] ?>">
                      </div>

                      <div class="form-group">
                        <label for="imagen_invitado" width="200">Imagen: </label>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="agregar-invitado">Guardar</button>
                  </div>
                </form>
            </div>
            <!-- /.box-body -->
