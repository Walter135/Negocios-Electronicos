                        ...
                        <li class="col-md-4">
                          <div class="tabla-precio text-center">
                            ...
                            <div class="orden">
                              ...
                              <input type="number"value=0 class="form-control" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0">
                        ...
                        <li class="col-md-4">
                          <div class="tabla-precio text-center">
                            ...
                            <div class="orden">
                              ...
                              <input type="number" value=0 class="form-control" min="0" id="pase_completo" size="3" name="boletos[completo][cantidad]" placeholder="0">
                        ...
                        <li class="col-md-4">
                          <div class="tabla-precio text-center">
                            ...
                            <div class="orden">
                              ...
                              <input type="number" value=0 class="form-control" min="0" id="pase_dosdias" size="3" name="boletos[2dias][cantidad]" placeholder="0">
                                    ...
                                    <div class="col-md-4">
                                      <p><?php echo $tipo; ?></p>
                                        ...
                                        <?php foreach ($evento_dia as $eventosss){ ?>      
                                          <label>
                                            <input type="checkbox" class="minimal" name="registro_evento[]" id="<?php echo $eventosss['id'] ?>" value="<?php echo $eventosss['id'] ?>">
