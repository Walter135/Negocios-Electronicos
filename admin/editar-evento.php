                ...
                <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-evento.php">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <select name="categoria_evento" class="form_control seleccionar">
                              <?php
                                try {
                    ...
                    <div class="form-group">
                      ...
                      <select name="invitado" class="form_control seleccionar">
                              <?php
                                try {
                  ...
                  <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="actualizar-modelo">Guardar</button>
                  </div>
                </form>
            </div>
            <!-- /.box-body -->
